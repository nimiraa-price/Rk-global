...
import nomadPrograms from '../../data/digitalNomadPrograms';

// Select curated list of programs to feature
const curatedSlugs = [
  { slug: 'uk-innovator-founder-visa', type: 'business', base: '/business-migration' },
  { slug: 'usa-e2-investor-visa', type: 'business', base: '/business-migration' },
  { slug: 'canada-ict-visa', type: 'business', base: '/business-migration' },
  { slug: 'portugal-d2-entrepreneur-visa', type: 'business', base: '/business-migration' },
  { slug: 'greece-fip-visa', type: 'nomad', base: '/digital-nomad' },
  { slug: 'spain-digital-nomad-visa', type: 'nomad', base: '/digital-nomad' },
  { slug: 'portugal-digital-nomad-visa', type: 'nomad', base: '/digital-nomad' }
];

const BusinessAndNomadPrograms = () => {
  const [activeCard, setActiveCard] = useState(0);
  const scrollContainerRef = useRef(null);

  // Map slugs to actual program data
  const programs = curatedSlugs.map((curated, index) => {
    const sourceData = curated.type === 'business' ? businessPrograms : nomadPrograms;
    const program = sourceData.find(p => p.slug === curated.slug);
      ...
      >
        <div className="max-w-[1400px] mx-auto px-4 md:px-8 flex flex-col items-center">
          ...
          <div className="text-center mb-6 md:mb-10">
            ...
            >
              Business Immigration & Nomad Visas
            </h2>
            <p
              className="text-[#8c8c8c] max-w-6xl mx-auto font-bold text-[14px] leading-[145%] md:text-[18px] md:leading-[145%]"
            >
              Expand your enterprise globally or work remotely from top international destinations.
            </p>
          </div>
...
export default BusinessAndNomadPrograms;
